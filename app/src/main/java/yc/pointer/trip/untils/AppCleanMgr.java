...
public class AppCleanMgr {
    ...
    public static void cleanSharedPreference(Context context) {
        AppFileMgr.deleteFilesByDirectory(new File("/data/data/" + context.getPackageName() + "HistorySearch"));
...
//        AppFileMgr.deleteFilesByDirectory(context.getFilesDir());
    ...
    public static int cleanApplicationData(Context context) {
        ...
        cleanFiles(context);
        //根据文件路径删除文件
        AppFileMgr.deleteFiles(Environment.getExternalStorageDirectory() + "/photos");
    ...
    public static String getAppClearSize(Context context) {
        ...
        clearSize += AppFileMgr.getFileSize(new File("/data/data/" + context.getPackageName() + "/HistorySearch"));
