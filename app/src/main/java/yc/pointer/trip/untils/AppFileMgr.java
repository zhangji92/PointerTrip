...
public class AppFileMgr {
    ...
    public static String FormentFileSize(long fileS) {
        ...
        if (fileS < 1024) {
            fileSizeString = df.format((int) fileS) + "B";
        } else if (fileS < 1048576) {
            fileSizeString = df.format((int) fileS / 1024) + "K";
        } else if (fileS < 1073741824) {
            fileSizeString = df.format((int) fileS / 1048576) + "M";
        } else {
            fileSizeString = df.format((int) fileS / 1073741824) + "G";
        }
    ...
    public static long getFreeSpace() {
        ...
        Log.e("AppFileMgr", "totalSpace：" + blockSize * totalBlocks + "...availableSpace：" + blockSize * availableBlocks);
    ...
    public static String getSDPath(Context context) {
        ...
        File eis = new File(sdDir.toString() + "/DCIM/Camera/");
        try {
            if (!eis.exists()) {
                eis.mkdir();
            }
