...
//        List<CompressTrack> tracks = movie.getCompressTracks();
//        movie.setTracks(new LinkedList<CompressTrack>());
////        for (CompressTrack track : tracks) {
////            printTime(track);
////        }
//
...
//    protected static long getDuration(CompressTrack track) {
//        long duration = 0;
...
//    private static double correctTimeToSyncSample(CompressTrack track, double cutHere, boolean next) {
...
//    }
  ...
  /*  private static void printTime(CompressTrack track) {
        double[] timeOfSyncSamples = new double[track.getSyncSamples().length];
        long currentSample = 0;
        double currentTime = 0;
        for (int i = 0; i < track.getDecodingTimeEntries().size(); i++) {
