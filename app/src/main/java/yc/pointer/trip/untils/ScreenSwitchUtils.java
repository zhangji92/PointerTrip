...
public class ScreenSwitchUtils {
    ...
    private boolean isLandscape = true;//右转屏
                ...
                case 888:
                    ...
                    if (orientation > 45 && orientation < 135) {
                        if (isLandscape){
                            isLandscape=false;
                            //右转屏
                            mOnCallBack.animatorRotation(0);//右转屏
                        }
                        ...
                        if (isPortrait) {
                            ...
                            mOnCallBack.animatorRotation(1);//
                            //左转屏
                            //Log.e(test, 切换成横屏);
                        ...
                        if (!isPortrait) {
                            ...
                            mOnCallBack.animatorRotation(2);
                        }
                    }
                    break;
                default:
    ...
    public interface onCallBack {
        void animatorRotation(int type);
    }
}
