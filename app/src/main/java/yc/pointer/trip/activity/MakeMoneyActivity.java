...
//        permissionHelper=new PermissionHelper(getActivity(),this,permissionModels);
        if (islogin) {
            ...
            goLogin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //跳转登录
                    Intent intent = new Intent(MakeMoneyActivity.this, LoginActivity.class);
        ...
        if (!StringUtil.isEmpty(mLocalCity)) {
            ...
            if (Build.VERSION.SDK_INT < 23) {
                ...
                //申请权限
                isPermission = true;
                permissionHelper = new PermissionHelper(MakeMoneyActivity.this, new PermissionHelper.OnAlterApplyPermission() {
                    @Override
        ...
        makeMoneyAdapter.setItemViewOnClickListener(new MakeMoneyAdapter.itemViewOnClickListener() {
            ...
            public void OnClickBack(String oid) {
                Intent intent = new Intent(MakeMoneyActivity.this, NewOrderDetailActivity.class);
    ...
    private void showVierfy(String title, String buttontext, String note) {
        ...
        buttonGoVerify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MakeMoneyActivity.this, VerifyActivity.class);
