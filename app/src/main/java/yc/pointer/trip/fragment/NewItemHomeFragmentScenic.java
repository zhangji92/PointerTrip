...
import yc.pointer.trip.event.NewItemHomeEventScenic;
...
public class NewItemHomeFragmentScenic extends BaseViewPageFragment implements NewHomeFragmentMoveItemAdapter.ItemHomeMoveRecycler,
    ...
    public static Fragment newInstance(int key) {
        NewItemHomeFragmentScenic fragment = new NewItemHomeFragmentScenic();
    ...
    private void requestHomePageData(String userId, String devcode, Long timestamp, int page, int type) {
        ...
        if (timeFlag) {
            ...
            RequestBody requestBody = new FormBody.Builder()
                    ...
                    .add("uid", userId)
                    .build();
            OkHttpUtils.getInstance().post(URLUtils.HOME_VIDEO_NEW_DATA, requestBody, new HttpCallBack(new NewItemHomeEventScenic()));
        }
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void requestHomePageData(NewItemHomeEventScenic event) {
        if (event.isTimeOut()) {
            mLoadDialog.dismiss();
