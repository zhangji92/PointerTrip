...
import yc.pointer.trip.event.NewItemHomeEventRiding;
...
public class NewItemHomeFragmentRiding extends BaseViewPageFragment implements NewHomeFragmentMoveItemAdapter.ItemHomeMoveRecycler,
    ...
    public static Fragment newInstance(int key) {
        NewItemHomeFragmentRiding fragment = new NewItemHomeFragmentRiding();
    ...
    private void requestHomePageData(String userId, String devcode, Long timestamp, int page, int type) {
        ...
        if (timeFlag) {
            ...
            RequestBody requestBody = new FormBody.Builder()
                    ...
                    .add("uid", userId)
                    .build();
            OkHttpUtils.getInstance().post(URLUtils.HOME_VIDEO_NEW_DATA, requestBody, new HttpCallBack(new NewItemHomeEventRiding()));
        }
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void requestHomePageData(NewItemHomeEventRiding event) {
        if (event.isTimeOut()) {
            mLoadDialog.dismiss();
