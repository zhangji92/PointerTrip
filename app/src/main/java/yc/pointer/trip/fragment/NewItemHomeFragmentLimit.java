...
import yc.pointer.trip.event.NewItemHomeEventLimit;
...
public class NewItemHomeFragmentLimit extends BaseViewPageFragment implements NewHomeFragmentMoveItemAdapter.ItemHomeMoveRecycler,
    ...
    public static Fragment newInstance(int key) {
        NewItemHomeFragmentLimit fragment = new NewItemHomeFragmentLimit();
    ...
    private void requestHomePageData(String userId, String devcode, Long timestamp, int page, int type) {
        ...
        if (timeFlag) {
            ...
            RequestBody requestBody = new FormBody.Builder()
                    ...
                    .add("uid", userId)
                    .build();
            OkHttpUtils.getInstance().post(URLUtils.HOME_VIDEO_NEW_DATA, requestBody, new HttpCallBack(new NewItemHomeEventLimit()));
        }
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void requestHomePageData(NewItemHomeEventLimit event) {
        if (event.isTimeOut()) {
            mLoadDialog.dismiss();
