...
public class NewItemHomeFragmentFolk extends BaseViewPageFragment implements NewHomeFragmentMoveItemAdapter.ItemHomeMoveRecycler,
    ...
    public static Fragment newInstance(int key) {
        NewItemHomeFragmentFolk fragment = new NewItemHomeFragmentFolk();
    ...
    private void requestHomePageData(String userId, String devcode, Long timestamp, int page, int type) {
        ...
        if (timeFlag) {
            ...
            RequestBody requestBody = new FormBody.Builder()
                    ...
                    .add("uid", userId)
                    .build();
            OkHttpUtils.getInstance().post(URLUtils.HOME_VIDEO_NEW_DATA, requestBody, new HttpCallBack(new NewItemHomeEventFolk()));
        }
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void requestHomePageData(NewItemHomeEventFolk event) {
        if (event.isTimeOut()) {
            mLoadDialog.dismiss();
