...
public class NewHomeFragmentMoveItem extends RecyclerView.Adapter<NewHomeFragmentMoveItem.FragmentViewHolder> {

    private List<DataGoodBean> mList;

    public NewHomeFragmentMoveItem(List<DataGoodBean> res) {
        this.mList = res;
    }
