...
public class NewHomeFragmentMoveItemAdapter extends RecyclerView.Adapter<NewHomeFragmentMoveItemAdapter.FragmentViewHolder> {

    private List<DataGoodBean> mList;

    public NewHomeFragmentMoveItemAdapter(List<DataGoodBean> res) {
        this.mList = res;
    }
